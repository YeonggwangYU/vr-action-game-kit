using _3DGamekitLite.Scripts.Runtime.Game.Localization;
using UnityEditor;
using UnityEngine;

namespace _3DGamekitLite.Scripts.Editor.Game.Localization
{
    [CustomEditor(typeof(TranslatedPhrases))]
    public class TranslatedPhrasesEditor : UnityEditor.Editor
    {
